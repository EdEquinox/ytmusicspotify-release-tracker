...
from core.config import SPOTIFY_ACCOUNTS_URL
...
from services.jobs_service import _is_valid_hhmm
from services.settings_service import _read_settings, _write_settings
from services.spotify_api import _reverse_spotify_cache_path
    ...
    with state._settings_lock:
        ...
        updated = current.model_copy(
            update={
                ...
                "reverse_tidal_only": payload.reverse_tidal_only,
