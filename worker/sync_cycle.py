...
from album_tracks import _album_audio_only_video_ids, _album_track_video_ids
from backend_client import _create_error, _delete_csv_item, _fetch_csv_releases
from matching import _build_query
...
from search_pickers import _pick_album_browse_id, _pick_single_video_id, _pick_video_id
    ...
    for release in releases:
        ...
        try:
            ...
            if _is_ytmusic_auth_error(exc):
                ...
                return "ytmusic_auth_error"
            _create_error(backend_url, release, f"Failed to add on YTMusic: {exc}", clear_csv_on_resolve=True)
